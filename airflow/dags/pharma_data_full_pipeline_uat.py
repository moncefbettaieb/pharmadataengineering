...
with DAG('pharma_data_full_pipeline_uat',
    ...
    dbt_run_uat = create_cloud_run_task_dbt("run", "run", "uat", exclude_model="intermediate.dim_match_categorie_taxonomy")
    ...
    airbyte_postgre_to_firestore = AirbyteTriggerSyncOperator(
        ...
        airbyte_conn_id='airbyte_conn',
        connection_id='9d4f3880-5d71-4b03-ad38-82be20bcc5ef',
        asynchronous=False,
        timeout=3600,
        wait_seconds=3
    )
